...
class ReadScreenCrudDBTwo extends StatefulWidget {
  ...
  ReadScreenCrudDBTwo({super.key, required this.args});

  @override
  State<ReadScreenCrudDBTwo> createState() => _ReadScreenCrudDBTwoState();
}

class _ReadScreenCrudDBTwoState extends State<ReadScreenCrudDBTwo> {
  ...
  getStudentRecord() async {
    DatabaseHelper.instance.queryAllRows().then((v) {
      setState(() {
        studentList = v;
      });
    });
