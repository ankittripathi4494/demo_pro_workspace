// ignore_for_file: avoid_print, must_be_immutable, depend_on_referenced_packages, use_build_context_synchronously
...
class UpdateScreenCrudDBTwo extends StatefulWidget {
  late Map<String, dynamic> args;
  UpdateScreenCrudDBTwo({super.key, required this.args});
  @override
  State<UpdateScreenCrudDBTwo> createState() => _UpdateScreenCrudDBTwoState();
}

class _UpdateScreenCrudDBTwoState extends State<UpdateScreenCrudDBTwo> {
  ...
  getRecordForUser() async {
    DatabaseHelper.instance
        .queryRowById(int.parse(widget.args['id']))
        .then((v) {
      print(v.toString());
      setState(() {
  ...
  updateRecordInDatabase(String name, String phone, String email, String dob,
    ...
    }, int.parse(widget.args['id'])).then((v) {
